  ...
  return (
    <div className="fixed inset-0 z-50 bg-ink/60 backdrop-blur-sm flex items-center justify-center p-4">
      <div className="bg-white rounded-xl w-full max-w-md shadow-2xl overflow-hidden">
        {/* Header */}
        <div
          className="bg-ink px-6 py-5 flex items-center justify-between"
          style={{ background: "#0f8a78" }}
        >
          <div>
            <p className="text-[10px] tracking-[2px] uppercase text-black font-semibold">
              Send Inquiry
            </p>
